...
describe('Parser', function() {
  ...
  describe('values', function() {
    it('parses dimensions', function() {
      assert.deepEqual(parseValues('10px 1.2em 5.1%'),
                        [ new nodes.Literal('10px'),
  ...
  describe('variables', function() {
    it('parses variable', function() {
      assert.deepEqual(parseDeclaration('height: @a'),
              new nodes.Property('height', [ new nodes.Variable('@a') ]))
    })

    it('parses assignation', function() {
      assert.deepEqual(parseDeclaration('@a: 1'),
